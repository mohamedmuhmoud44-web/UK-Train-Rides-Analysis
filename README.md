...
- **Total Passengers** – Total number of passengers using railway services  
- **Average Ticket Price** – Average ticket cost across journeys  
- **Delay Rate** – Percentage of delayed journeys  
- **On-Time Performance** – Percentage of trains arriving on schedule  
- **Refund Requests** – Number of refund requests caused by delays or cancellations  
